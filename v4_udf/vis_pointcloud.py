...
if __name__ == '__main__':
    ...
    Data = DDL(root=Args.input_dir, name=Args.dataset, train=Args.val, download=False, target_samples=Args.rays_per_shape, usePositionalEncoding=Args.use_posenc, aug=True)
